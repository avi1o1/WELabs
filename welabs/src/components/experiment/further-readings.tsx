...
const FurtherReadingsContent: React.FC<FurtherReadingsProps> = ({
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Quizzes and Assessments Section */}
      <div
        className={`rounded-xl shadow-md p-6 border ${
          isDarkMode
            ? "bg-gray-800 border-gray-700"
      ...
      >
        ...
        <p className={`mb-6 ${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>
          Test your knowledge of sorting algorithms with these interactive
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            {
              title: "MCQ Quiz for Bubble Sort",
              description: "Test your theoretical knowledge",
              link: "/bubble-sort-mcq",
              color: isDarkMode
            ...
            {
              title: "Combined Quiz for Sorting Algorithms",
              description: "Compare different sorting techniques",
              link: "/sorting-algorithms-quiz",
              color: isDarkMode
            ...
            },
            {
              ...
              description: "Implement optimized versions of Bubble Sort",
              link: "/bubble-sort-challenge",
              color: isDarkMode
            ...
            <div key={index} className={`rounded-lg border p-5 ${item.color}`}>
              <div className="flex items-center">
                <svg
                  className={`w-5 h-5 mr-2 ${item.textColor}`}
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
              ...
              <a
                href={item.link}
                className={`inline-flex items-center text-sm font-medium ${item.textColor} hover:underline`}
              >
                Take quiz
                <svg
