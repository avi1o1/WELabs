    ...
    beginner: [
      ...
      },
      {
        ...
        options: [
          ...
          {
            label: "It requires additional memory proportional to input size",
            value: "d",
          },
        ],
        correctAnswer: "c",
    ...
    advanced: [
      {
        ...
        options: [
          ...
          {
            label: "Using a flag to detect if any swaps were made",
            value: "b",
          },
      ...
      },
      {
        ...
        options: [
          {
            label:
              "It can be optimized to detect if the array is already sorted",
            value: "a",
          },
          { label: "It is a comparison-based sorting algorithm", value: "b" },
          { label: "It is an in-place sorting algorithm", value: "c" },
          {
            label: "It has a best-case time complexity of O(log n)",
            value: "d",
          },
        ],
        correctAnswer: "d",
